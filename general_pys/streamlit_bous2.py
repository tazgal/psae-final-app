...
def number_rows():
    return multiselect  # Απλά επιστρέφει την τιμή του multiselect
...
if st.button("🖨️ Δημιούργησε PDF"):
    ...
    # ΔΙΟΡΘΩΜΕΝΟ: Χρήση του πραγματικού αριθμού γραμμών από το DataFrame
    actual_rows = len(selected_df)  # Πραγματικός αριθμός γραμμών δεδομένων
    ...
    total_table_rows = len(table_data)  # Headers + data rows
    ...
    # ΔΙΟΡΘΩΜΕΝΟ: Χρήση του σωστού αριθμού γραμμών για rowHeights
    table = Table(table_data, colWidths=col_widths, rowHeights=[row_height] * total_table_rows)

    # Στυλ πίνακα - ΜΕ ΤΑ ΝΕΑ FONT SETTINGS
    style = TableStyle([
        # Βασικά στυλ για όλο τον πίνακα
        ...
        # Headers (όλες οι στήλες)
        ('FONTSIZE', (0, 0), (-1, 0), 10),
        ('FONTNAME', (0, 0), (-1, 0), 'Helvetica-Bold'),
        
        # Στήλη 0 & 2 (πρώτη και τρίτη) - BOLD και μεγαλύτερες
        ('FONTNAME', (0, 1), (0, -1), 'Helvetica-Bold'),      # Στήλη 0 - Bold
        ('FONTSIZE', (0, 1), (0, -1), 11),                   # Στήλη 0 - Μεγαλύτερο
        ('FONTNAME', (2, 1), (2, -1), 'Helvetica-Bold'),      # Στήλη 2 - Bold
        ('FONTSIZE', (2, 1), (2, -1), 11),                   # Στήλη 2 - Μεγαλύτερο
        
        # Στήλη 1 & 3 (δεύτερη και τέταρτη) - Regular αλλά μεγαλύτερες
        ('FONTNAME', (1, 1), (1, -1), 'Helvetica'),          # Στήλη 1 - Regular
        ('FONTSIZE', (1, 1), (1, -1), 10),                   # Στήλη 1 - Λίγο μεγαλύτερο
        ('FONTNAME', (3, 1), (3, -1), 'Helvetica'),          # Στήλη 3 - Regular
        ('FONTSIZE', (3, 1), (3, -1), 10),                   # Στήλη 3 - Λίγο μεγαλύτερο
    ])
    ...
    # Σβήσε ΜΟΝΟ τις εσωτερικές οριζόντιες γραμμές
    for (_, (x1, y1), (x2, y2)) in span_commands:
        # Αφαίρεση εσωτερικών οριζόντιων γραμμών

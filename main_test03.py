...
######## 
########  Περίοδος ενασχόλησης 27/12/2025 - 30/12/2025
######## Ημερολόγιο (στήλες, καταχωρήσεις κοκ)
######## template για ΒΔ
# Στην πρώτη ενότητα, μια φόρμα όπου να συμπληρώνονται τα διάφορα πεδία του πίνακα
#       - Οικονομία, Διεθνής Οικονομία, Γεωστρατηγική, Εμπλοκή, Πολιτική, Osint
